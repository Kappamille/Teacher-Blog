---
title: "B2.3 Programming constructs"
permalink: /curriculum/b2/b2-3/
layout: single
...
Studied throughout all the classes

## B2.3.2 Construct programs utilizing appropriate selection structures.

• Must include: if, else, else if (Java) to execute different code blocks based on specified
conditions
