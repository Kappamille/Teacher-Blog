---
title: "B2.4 Programming algorithms"
permalink: /curriculum/b2/b2-4/
layout: single
...
## B2.4.2 Construct and trace algorithms to implement a linear search and a binary search for dataretrieval.
...
• The utility of recursion in solving problems that can be broken down into smaller, similar sub-
problems
...
• Situations that best suit the use of recursion, including fractal image creation, traversing binary trees,
sorting algorithms
...
<iframe src="{{ site.baseurl }}/assets/pdfs/Recursion.pdf" width="100%" height="600px">
  This browser does not support PDFs. Please download the file: 
  <a href="{{ site.baseurl }}/assets/pdfs/Recursion.pdf">Download PDF</a>.
</iframe>
